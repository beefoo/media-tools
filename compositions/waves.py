...
parser.add_argument('-scale', dest="SCALE_AMOUNT", default=1.5, type=float, help="Amount to scale clip")
...
parser.add_argument('-volr', dest="VOLUME_RANGE", default="0.3,0.75", help="Volume range")
a = parser.parse_args()
parseVideoArgs(a)
aa = vars(a)
